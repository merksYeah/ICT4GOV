<%-- 
    ...
    Created on : 03 20, 17, 6:49:41 PM
    Author     : migue
--%>
<%@ taglib prefix="c" 
        ...
        <div id="page-content-wrapper">
           ...
           <nav class="navbar navbar-default navbar-static-top">
                <div class="navbar-header">
                    <a href="#" class="navbar-brand" style="color: white;">Complaint Tracker</a>
                </div>
			...
			<div id="left-half">
                ...
                <form class="" action="showComplaintTracker">
                           ...
                           <div class="panel panel-default">
                            ...
                            <c:forEach items="${complaints}" var="Complaint">
                                    <div class="panel-body">
                                         Status: <c:out value="${Complaint.complaintStatusDesc}"/>
                                    </div>
                                   
                                   <c:choose>
                                    <c:when test="${empty Complaint.hearingDate}">
                                    <div class="panel-body">
                                    ...
                                    <c:otherwise>
                                    <div class="panel-body">
                                      Hearing Date = <c:out value="${Complaint.hearingDate}"/>
                                    </div>
