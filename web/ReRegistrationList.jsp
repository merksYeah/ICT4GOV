        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top">
                <div class="navbar-header">
                    <a href="#" class="navbar-brand" style="color: white;">List of Re-registrations</a>
                </div>
            ...
            <div class="container-fluid">
			    ...
			    <th>Vehicle Plate Number</th>
                    ...
                    <c:forEach items="${applications}" var="Application">
                        <tr>
                            <td><a href="showReRegisterDetails?case_num=<c:out value="${Application.caseNumber}"/>"><c:out value="${Application.caseNumber}"/></td>
                            <td><c:out value="${Application.tradeName}"/></td>
                            <td><c:out value="${Application.plateNumber}"/></td>
