    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li><a href="showLegalApplications"><span class="glyphicon glyphicon-home" color="white"></a>
                </li>
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top">
                <div class="navbar-header">
                    <a href="#" class="navbar-brand" style="color: white;">List of Applications</a>
                </div>
            ...
            <div class="container-fluid">
                ...
                <table id="" class="display" cellspacing="0" width="100%">
                    ...
                    <c:forEach items="${applications}" var="Application">
                        <tr>
                            <td><a href="showLegalApplicationDetails?case_num=<c:out value="${Application.caseNumber}"/>"><c:out value="${Application.caseNumber}"/></td>
