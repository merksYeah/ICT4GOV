<%-- 
    Document   : FranchisOwnerComplaints
    Created on : 03 20, 17, 8:33:35 PM
    Author     : migue
--%>
<%@ taglib prefix="c" 
...
<head>
    ...
    <title>Franchise Owner: List of Complaints</title>
            ...
            <div class="container-fluid">
                ...
                <table id="" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <td><a href="showFranchiseComplaintDetails?ref_num=<c:out value="${Complaint.reference_number}"/>"><c:out value="${Complaint.reference_number}"/></td>
